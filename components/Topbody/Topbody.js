...
export default function Side(){
    return(
        ...
        <div className={s.right}>
            <ul>
                <li>Step 1 - Get started by adding your favourite websites to your account as content source for widget. Watch Video</li>
        
                <li>Step 2 - Customize the look and feel of the widget to match your website style.</li>

                <li>Step 3 - Click on "Save and Get Code" button, copy the embed code and paste on your website.</li>

                <li>Step 4 - Widget updates automatically when new content is available.</li>

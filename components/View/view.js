...
export default function View({ isCollapsed }) {
  // Get state and actions from Zustand store
  const { selectedLayout, formData, handleFormChange, setSelectedLayout } =
    useWidgetStore();
  ...
  const handleImageClick = (index) => {
    ...
    // Save to form data using Zustand's handleFormChange
